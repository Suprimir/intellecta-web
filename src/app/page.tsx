  ...
  return (
    <div className="grid grid-cols-3 grid-rows-1">
        ...
        <div className="lg:grid lg:grid-cols-4 h-full max-w-[90%] mx-auto gap-6">
          <div className="col-span-4 xl:col-span-2 2xl:col-span-3 flex flex-col h-full">
            <div className="flex-1 flex flex-col justify-center xl:items-start space-y-8 items-center">
              <h1 className="text-center xl:text-start text-5xl lg:text-[5rem] xl:text-6xl 2xl:text-[5rem] font-extrabold leading-tight max-w-[100%]">
                Contamos con +20 cursos con certificados en diversas áreas
              </h1>
              <Hyperlink
                text="Regístrate gratis"
                href="/auth/register"
                className="bg-black text-white font-bold py-3 px-6 rounded-lg text-2xl hover:bg-gray-800 transition-colors whitespace-nowrap"
              />
            </div>
          </div>
      ...
      <div className="col-span-3 row-start-2 bg-white">
        <div className="flex grid-cols-2 max-w-[100%] sm:max-w-[80%] md:max-w-[70%] lg:max-w-[70%] xl:max-w-[70%] 2xl:max-w-[55%] mx-auto py-8 items-center justify-between z-10">
